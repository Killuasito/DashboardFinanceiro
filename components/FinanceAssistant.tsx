  ...
  return (
    <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-xl border-2 border-blue-200 dark:border-blue-900">
      <div className="flex items-center gap-2 mb-4">
        <div className="p-2 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg">
          <FiCpu size={20} />
        </div>
        <div>
      ...
      <form onSubmit={handleSend} className="flex items-center gap-3">
        ...
        <button
          type="submit"
          disabled={loading}
          className="inline-flex items-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold shadow-lg hover:shadow-xl hover:scale-105 transition disabled:opacity-60 disabled:hover:scale-100"
        >
          <FiSend size={18} />
